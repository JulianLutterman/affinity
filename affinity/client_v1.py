...
class AffinityV1:
    """
    Minimal v1 client for create actions and simple org search.
    v1 uses Basic auth with the API key as the username.
    """
    ...
    # ---- Simple company search (v1)
    def search_companies(self, term: str):
        # Common v1 pattern: GET /organizations?term=<query>
        return self._req("GET", "/organizations", params={"term": term})
